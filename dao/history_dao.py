...
class History_dao:
    ...
    def insert(self, user, trans_date, trans_type, stock, price, total_price, volume):
        self.db.query("insert into history (user, trans_date, trans_type, stock, price, total_price, volume) values ('%s','%s','%s','%s','%s','%s',%d)"%(user, trans_date, trans_type, stock, round(Decimal(price),2), round(Decimal(total_price),2), volume)+";")
