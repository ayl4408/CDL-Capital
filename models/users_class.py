...
class Users:
    ...
    def set_profit(self,x):
        db.query("update users set profit=('%s')"%(x)+ "where login=" + "'" + self.login + "'" + ";")
        self.profit = x
    ...
    def set_total_portfolio(self,x):
        db.query("update users set total_portfolio=('%s')"%(x) + "where login=" + "'" + self.login + "'" + ";")
    ...
    def set_available_funds(self,x):
        db.query("update users set available_funds=('%s')"%(x)+ "where login=" + "'" + self.login + "'" + ";")
    ...
    def set_total_stock_values(self,x):
        db.query("update users set total_stock_values=('%s')"%(x) + "where login=" + "'" + self.login + "'" + ";")
    ...
    def set_total_deposited(self,x):
        db.query("update users set total_deposited=('%s')"%(x) + "where login=" + "'" + self.login + "'" + ";")
